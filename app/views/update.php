...
<div class="user-update">
	...
	<legend>Update your password</legend>
		<form method='post' action='/me/update'>
			...
			<input type="password" placeholder="Your old password" required="Required field" name="old-password" />
			<label for="password">New password</label>
			<input type="password" placeholder="Your new password" required="Required field" name="new-password" />
			<label for="confirm">Confirm</label>
